...
/// </summary>
public sealed class ContentUnpublishedTriggerSettings : IAutomationOriginatedEventBehavior
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets how the trigger should react to unpublishes performed by another automation.
