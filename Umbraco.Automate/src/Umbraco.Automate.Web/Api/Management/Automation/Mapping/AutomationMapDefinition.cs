...
public class AutomationMapDefinition : IMapDefinition
{
    ...
    // Umbraco.Code.MapAll -Alias -Name -Id -WorkspaceId -Status -PublishedVersion -DraftVersion -GroupId -Version -DateCreated -DateModified -CreatedByUserId -ModifiedByUserId
    ...
    // Umbraco.Code.MapAll -Id -WorkspaceId -Status -PublishedVersion -DraftVersion -GroupId -Version -DateCreated -DateModified -CreatedByUserId -ModifiedByUserId
