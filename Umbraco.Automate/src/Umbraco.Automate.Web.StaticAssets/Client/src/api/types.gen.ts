...
export type ClientOptions = {
    baseUrl: 'https://127.0.0.1:58067' | (string & {});
};
...
export type AutomationRunListItemResponseModel = {
    id: string;
    automationId: string;
    automationName: string;
...
export type PagedAutomationRunListItemResponseModel = {
    total: number;
    items: Array<AutomationRunListItemResponseModel>;
};
...
export type PostApprovalsByRunIdStepsByStepIdDecisionError = PostApprovalsByRunIdStepsByStepIdDecisionErrors[keyof PostApprovalsByRunIdStepsByStepIdDecisionErrors];
...
export type GetRunsData = {
    ...
    url: '/umbraco/automate/management/api/v1/runs';
};
...
export type GetRunsResponses = {
     ...
     * OK
     */
    200: PagedAutomationRunListItemResponseModel;
};
