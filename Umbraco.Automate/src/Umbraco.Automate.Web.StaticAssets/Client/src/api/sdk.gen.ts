...
export class AutomationsService {
    ...
    public static getAutomationsByIdMcpUrl<ThrowOnError extends boolean = false>(options: Options<GetAutomationsByIdMcpUrlData, ThrowOnError>) {
        return (options.client ?? client).get<GetAutomationsByIdMcpUrlResponses, GetAutomationsByIdMcpUrlErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    public static getAutomationsByIdWebhookUrl<ThrowOnError extends boolean = false>(options: Options<GetAutomationsByIdWebhookUrlData, ThrowOnError>) {
        return (options.client ?? client).get<GetAutomationsByIdWebhookUrlResponses, GetAutomationsByIdWebhookUrlErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
...
export class RunsService {
    public static getRuns<ThrowOnError extends boolean = false>(options?: Options<GetRunsData, ThrowOnError>) {
        return (options?.client ?? client).get<GetRunsResponses, GetRunsErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
