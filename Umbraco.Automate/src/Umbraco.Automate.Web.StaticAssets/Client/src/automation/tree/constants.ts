export const UA_AUTOMATION_TREE_ALIAS = "UmbracoAutomate.Tree.Automation";
export const UA_AUTOMATION_TREE_REPOSITORY_ALIAS = "UmbracoAutomate.Repository.Automation.Tree";
export const UA_AUTOMATION_TREE_STORE_ALIAS = "UmbracoAutomate.Store.Automation.Tree";
