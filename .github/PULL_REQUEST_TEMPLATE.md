...
- [ ] Branch name follows the convention (`vN/feature/<anything>`, see [CONTRIBUTING.md](https://github.com/umbraco/Umbraco.Automate/blob/v17/dev/CONTRIBUTING.md#branch-naming-convention))
...
Umbraco.Automate maintains several version lines at once and they are never forward-merged, so each line needs its own PR. See the [backport workflow](https://github.com/umbraco/Umbraco.Automate/blob/v17/dev/CONTRIBUTING.md#development-workflow).
